...
public:
	...
	Block_GC(int size, void(*err_function)(char *) = NULL) { first = last = NULL; block_size = size; error_function = err_function; }

	/* Destructor. Deallocates all items added so far */
	~Block_GC() { while (first) { block *next = first->next; delete[]((char*)first); first = next; } }
